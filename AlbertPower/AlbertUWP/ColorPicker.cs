...
using static Albert.Power.Runtime.ColorUtility;
namespace Albert.Power.Runtime
{
	public class ColorPicker : Grid
	{
		...
		#region Main Field's 
		readonly Rectangle _actColorElement;
		readonly Polygon _fleche;
		Rectangle _spectreChoice;
		Color _actSpectre;
		SolidColorBrush _actColor;
		readonly Grid _choiceGrid;
		Canvas _pickerCanvas;
		Grid _gridEllipse;
		double _x;
		double _y;
		bool _actualColorChanged;
		#endregion
		...
		public static readonly DependencyProperty SpectrePointerColorProperty = DependencyProperty.Register(
			"SpectrePointerColor", typeof(Color), typeof(ColorPicker), new PropertyMetadata(default(Color), (sender, e) =>
			{
				var classe = sender as ColorPicker;
				classe?.UpdateSpectrePointerColor();
			}));

		public static readonly DependencyProperty ColorProperty = DependencyProperty.Register(
		"Color", typeof(Color), typeof(ColorPicker), new PropertyMetadata(default(Color), (sender, e) =>
		{
			var classe = sender as ColorPicker;
		...
		public SolidColorBrush Brush
		{
			get
			{
				return BrushFromArgb(Color.A, Color.R, Color.G, Color.G);
			}
		}
		...
		#region Event's 
		/// <summary>
		/// Event raised when the actual color <see cref="Color"/>changed;
		/// </summary>
		...
		private void UpdateActualColor()
		{
			...
			_actColor = new SolidColorBrush(Color);
		...
		private void SpectreChoiceOnPointerPressed(object sender, PointerRoutedEventArgs args)
		{
			...
			Color = RecalculerCouleur();
			OnColorChanged?.Invoke(Color);
			_actColorElement.Fill = new SolidColorBrush(Color);
		...
		private void UpdatingColor(object sender, PointerRoutedEventArgs args)
		{
			...
			_actualColorChanged = true;
			Color = actColor;
			OnColorChanged?.Invoke(actColor);
		}
